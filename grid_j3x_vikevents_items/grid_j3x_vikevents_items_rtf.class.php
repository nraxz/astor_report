...
class grid_j3x_vikevents_items_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_j3x_vikevents_items.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_name']);
      }
   ...
   function NM_export_start_at()
   {
         ...
         $this->start_at = str_replace('<', '&lt;', $this->start_at);
         $this->start_at = str_replace('>', '&gt;', $this->start_at);
         $this->Texto_tag .= "<td>" . $this->start_at . "</td>\r\n";
   }
   //----- availnum
   function NM_export_availnum()
   {
         ...
         $this->availnum = str_replace('<', '&lt;', $this->availnum);
         $this->availnum = str_replace('>', '&gt;', $this->availnum);
         $this->Texto_tag .= "<td>" . $this->availnum . "</td>\r\n";
   }
   //----- img
   ...
   function NM_export_tsend()
   {
         ...
         $this->tsend = str_replace('<', '&lt;', $this->tsend);
         $this->tsend = str_replace('>', '&gt;', $this->tsend);
         $this->Texto_tag .= "<td>" . $this->tsend . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Astor Theatre Event Summary :: RTF</TITLE>
