 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['title'])) ? $this->New_label['title'] : "Title"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_title" name="title_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['start_at'])) ? $this->New_label['start_at'] : "Start At"; ?></TD>
      
      <INPUT type="hidden" id="SC_start_at_cond" name="start_at_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_start_at" <?php echo $str_hide_start_at?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_start_at"  <?php echo $str_display_start_at; ?> class="scFilterFieldFontEven">
