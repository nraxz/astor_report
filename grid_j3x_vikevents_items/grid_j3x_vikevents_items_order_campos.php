...
<?php
   ...
   $Ord_Cmp = new grid_j3x_vikevents_items_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_j3x_vikevents_items_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["id"] : "Id";
   $tab_ger_campos['title'] = "on";
   $tab_def_campos['title'] = "title";
   $tab_labels["title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["title"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["title"] : "Title";
   $tab_ger_campos['descr'] = "on";
   $tab_def_campos['descr'] = "descr";
   $tab_labels["descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["descr"] : "Descriptions";
   $tab_ger_campos['price'] = "on";
   $tab_def_campos['price'] = "price";
   $tab_labels["price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["price"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["price"] : "Price";
   $tab_ger_campos['start_at'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['start_at'] = "start_at";
   }
   else
   {
       $tab_def_campos['start_at'] = "FROM_UNIXTIME(tsinit)";
   }
   $tab_labels["start_at"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["start_at"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["start_at"] : "Start At";
   $tab_ger_campos['availnum'] = "on";
   $tab_def_campos['availnum'] = "availnum";
   $tab_labels["availnum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["availnum"])) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['labels']["availnum"] : "Availnum";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_j3x_vikevents_items_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_items']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
