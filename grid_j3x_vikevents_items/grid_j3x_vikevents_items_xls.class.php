...
class grid_j3x_vikevents_items_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_j3x_vikevents_items_res_xls.class.php");
              $this->Res_xls = new grid_j3x_vikevents_items_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_j3x_vikevents_items.zip";
          $this->Arquivo   .= "_grid_j3x_vikevents_items" . $this->Xls_tp;
          $this->Tit_doc    = "grid_j3x_vikevents_items" . $this->Xls_tp;
          $this->Tit_zip    = "grid_j3x_vikevents_items.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_j3x_vikevents_items_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_j3x_vikevents_orders_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_j3x_vikevents_orders_cons_emb, 0, $pos) . "/grid_j3x_vikevents_orders_xls.class.php";
      if (!is_file($this->Ini->link_grid_j3x_vikevents_orders_cons_emb) || !is_file($link_xls))
      {
      ...
      $pos      = strrpos($this->Ini->link_grid_j3x_vikevents_orders_cons_emb, '/');
      $link_xml = substr($this->Ini->link_grid_j3x_vikevents_orders_cons_emb, 0, $pos) . "/grid_j3x_vikevents_orders_xml.class.php";
      if (!is_file($this->Ini->link_grid_j3x_vikevents_orders_cons_emb) || !is_file($link_xml))
      {
          $this->NM_cmp_hidden['order'] = "off";
      }
      else
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_location = " = " . $this->Db->qstr($this->location);
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
   ...
   function NM_export_order()
   {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['nolabel'] = true;
         if (method_exists($this->grid_j3x_vikevents_orders, "controle"))
         {
             $this->grid_j3x_vikevents_orders->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['nolabel'])
       {
 ...
 function quebra_location_location($location) 
 {
   ...
   function quebra_location_location_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
