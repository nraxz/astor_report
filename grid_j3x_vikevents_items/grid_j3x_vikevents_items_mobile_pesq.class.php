...
class grid_j3x_vikevents_items_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_j3x_vikevents_items_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_j3x_vikevents_items_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_j3x_vikevents_items_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "FROM_UNIXTIME(tsinit)";$Nm_numeric[] = "id";$Nm_numeric[] = "tsend";$Nm_numeric[] = "tsendiscr";$Nm_numeric[] = "availnum";$Nm_numeric[] = "price";$Nm_numeric[] = "ts";$Nm_numeric[] = "published";$Nm_numeric[] = "archived";$Nm_numeric[] = "origid";$Nm_numeric[] = "origavailnum";$Nm_numeric[] = "multiprices";$Nm_numeric[] = "dayselection";$Nm_numeric[] = "forfaitprice";$Nm_numeric[] = "ownjuid";$Nm_numeric[] = "tsinitsale";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "j3x_vikevents_items.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_j3x_vikevents_items/grid_j3x_vikevents_items_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_j3x_vikevents_items_ajax_search.js"></script>
 <script type="text/javascript" src="grid_j3x_vikevents_items_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_j3x_vikevents_items_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_j3x_vikevents_items']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_j3x_vikevents_items']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_start_at_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_start_at_dia').value + '/';
    ...
    onClose: function(dateText, inst) {
          ...
          document.getElementById('SC_start_at_dia').value = aParts[0];
  ...
  $("#sc_start_at_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_start_at_input_2_dia').value + '/';
    ...
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_start_at_input_2_dia').value = aParts[0];
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Astor Theatre Event Summary</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $start_at_cond, $start_at, $start_at_dia, $start_at_mes, $start_at_ano, $start_at_input_2_dia, $start_at_input_2_mes, $start_at_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $title = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['title']; 
          $title_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['title_cond']; 
          $start_at_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_dia']; 
          $start_at_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_mes']; 
          $start_at_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_ano']; 
          $start_at_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_dia']; 
          $start_at_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_mes']; 
          $start_at_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_ano']; 
          $start_at_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_title_cond" name="title_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_title"  <?php echo $str_hide_title?>><?php
      if ($title != "")
      {
      $title_look = substr($this->Db->qstr($title), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_title" name="title" value="<?php echo NM_encode_input($title) ?>"  size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_title" name="title_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
  ...
  {
?>
<span id='id_date_part_start_at_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_dia" name="start_at_dia" value="<?php echo NM_encode_input($start_at_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_mes" name="start_at_mes" value="<?php echo NM_encode_input($start_at_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_ano" name="start_at_ano" value="<?php echo NM_encode_input($start_at_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_start_at"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_start_at"  <?php echo $str_display_start_at; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_start_at_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_input_2_dia" name="start_at_input_2_dia" value="<?php echo NM_encode_input($start_at_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_input_2_mes" name="start_at_input_2_mes" value="<?php echo NM_encode_input($start_at_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_at_input_2_ano" name="start_at_input_2_ano" value="<?php echo NM_encode_input($start_at_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_j3x_vikevents_items_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_j3x_vikevents_items']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_j3x_vikevents_items']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.start_at_dia.value = "";
   document.F1.start_at_mes.value = "";
   document.F1.start_at_ano.value = "";
   document.F1.start_at_input_2_dia.value = "";
   document.F1.start_at_input_2_mes.value = "";
   document.F1.start_at_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_start_at_dia').bind('change', function() {sc_grid_j3x_vikevents_items_valida_dia(this)});
    $('#SC_start_at_input_2_dia').bind('change', function() {sc_grid_j3x_vikevents_items_valida_dia(this)});
    $('#SC_start_at_input_2_mes').bind('change', function() {sc_grid_j3x_vikevents_items_valida_mes(this)});
    $('#SC_start_at_mes').bind('change', function() {sc_grid_j3x_vikevents_items_valida_mes(this)});
 }
 function sc_grid_j3x_vikevents_items_valida_dia(obj)
 {
 ...
 function sc_grid_j3x_vikevents_items_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $title_cond, $title, $title_autocomp,
             $start_at_cond, $start_at, $start_at_dia, $start_at_mes, $start_at_ano, $start_at_input_2_dia, $start_at_input_2_mes, $start_at_input_2_ano, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['title'] = $title; 
      if (is_array($title) && !empty($title))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][0] = $title;
      }
      elseif ($title_cond_salva == "nu" || $title_cond_salva == "nn" || $title_cond_salva == "ep" || $title_cond_salva == "ne" ||  !empty($title))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][0][0] = $title;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['title_cond'] = $title_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['cmp'] = "title"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['opc'] = $title_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq']['title'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_dia'] = $start_at_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_mes'] = $start_at_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_ano'] = $start_at_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_dia'] = $start_at_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_mes'] = $start_at_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2_ano'] = $start_at_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $start_at_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $start_at_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $start_at_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $start_at_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $start_at_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $start_at_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_cond'] = $start_at_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['cmp'] = "start_at"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid]['opc'] = $start_at_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq']['start_at'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($start_at_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $start_at_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $start_at = $val[0];
          $this->cmp_formatado['start_at'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['start_at'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['start_at'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($start_at_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']['start_at_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['start_at_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['start_at_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $start_at_cond == "NU" || $start_at_cond == "NN"|| $start_at_cond == "EP"|| $start_at_cond == "NE")
          {
              $this->monta_condicao("FROM_UNIXTIME(tsinit)", $start_at_cond, $start_at, $start_at_input_2, 'start_at', 'DATETIME');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq']['start_at']['label'] = $nmgp_tab_label['start_at'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq']['start_at']['descr'] = $nmgp_tab_label['start_at'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['grid_pesq']['start_at']['hint']  = $nmgp_tab_label['start_at'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_items']['cond_pesq'] .= $this->NM_operador;
