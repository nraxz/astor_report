<?php
@session_start() ;
$_SESSION['scriptcase']['grid_j3x_vikevents_items']['sc_process_barr'] = true;
require_once('../grid_j3x_vikevents_items/index.php');
unset($_SESSION['scriptcase']['grid_j3x_vikevents_items']['sc_process_barr']);
$ExportCtrl = new grid_j3x_vikevents_items_export_control;
$ExportCtrl->Export_barr();

class grid_j3x_vikevents_items_export_control
{
