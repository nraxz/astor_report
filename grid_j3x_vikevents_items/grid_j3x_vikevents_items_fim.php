...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____grid_j3x_vikevents_items"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____grid_j3x_vikevents_items"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_j3x_vikevents_items</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_items']['embutida_filho'] as $ind => $sc_init)
          {
