...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_Sales-Snapshots').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_Sales-Snapshots').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_Sales-Snapshots').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_Sales-Snapshots').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_Sales-Snapshots').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_Sales-Snapshots').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_Sales-Snapshots').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_Sales-Snapshots').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_Sales-Snapshots').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_Sales-Snapshots').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_Sales-Snapshots').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_Sales-Snapshots').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
