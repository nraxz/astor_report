<?php
@session_start() ;
$_SESSION['scriptcase']['Sales-Details']['sc_process_barr'] = true;
require_once('../Sales-Details/index.php');
unset($_SESSION['scriptcase']['Sales-Details']['sc_process_barr']);
$ExportCtrl = new Sales_Details_export_control;
$ExportCtrl->Export_barr();

class Sales_Details_export_control
{
