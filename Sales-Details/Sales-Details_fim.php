...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____Sales-Details"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____Sales-Details"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Sales-Details']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Sales-Details']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Sales-Details']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Sales-Details']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Sales-Details']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Sales-Details']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Sales-Details']['embutida_filho'] as $ind => $sc_init)
          {
