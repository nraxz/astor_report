...
class Sales_Details_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['Sales-Details']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['Sales-Details']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['contr_total_geral'] == "OK")
      {
          $this->array_total_location = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_total']['location'];
      }
      else
      {
          $this->array_total_location = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_total']['location'] = $this->array_total_location;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['title']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['title'] = "Title"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['descr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['descr'] = "Descriptions"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['price'] = "Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['start_at']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['start_at'] = "Start At"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['availnum']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['availnum'] = "Availnum"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['order'] = "order"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['img']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['img'] = "Img"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsend']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsend'] = "Tsend"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsendiscr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsendiscr'] = "Tsendiscr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['imgtwo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['imgtwo'] = "Imgtwo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['location']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['location'] = "Location"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['idcats']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['idcats'] = "Idcats"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['ts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['ts'] = "Ts"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['smalldescr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['smalldescr'] = "Smalldescr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['maps']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['maps'] = "Maps"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['params']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['params'] = "Params"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['published']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['published'] = "Published"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['archived']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['archived'] = "Archived"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['origid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['origid'] = "Origid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['origavailnum']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['origavailnum'] = "Origavailnum"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['multiprices']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['multiprices'] = "Multiprices"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['dayselection']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['dayselection'] = "Dayselection"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['excludedays']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['excludedays'] = "Excludedays"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['loclat']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['loclat'] = "Loclat"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['loclng']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['loclng'] = "Loclng"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['fgroupname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['fgroupname'] = "Fgroupname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['imggview']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['imggview'] = "Imggview"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['cpayments']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['cpayments'] = "Cpayments"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['sessions']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['sessions'] = "Sessions"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['alias']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['alias'] = "Alias"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['forfaitprice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['forfaitprice'] = "Forfaitprice"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['ownjuid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['ownjuid'] = "Ownjuid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsinitsale']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['labels']['tsinitsale'] = "Tsinitsale"; 
       }
       //-----
       $this->comp_field_nm = array(
           'location' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_order']['location']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_order']['location'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_order']['location'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['summarizing_fields_display']['location'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Sales-Details@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new Sales_Details_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['arr_total'][$cmp_gb];
      }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Sales-Details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Sales-Details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Sales-Details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Sales-Details/Sales-Details_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Sales-Details/Sales-Details_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Sales-Details/Sales-Details_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=Sales-Details&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Sales-Details/Sales-Details_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("Sales-Details_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Sales-Details']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Sales-Details']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'Sales-Details_config_pivot.php?nome_apl=Sales-Details&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Sales-Details_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "Sales-Details/Sales-Details_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Sales-Details']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
