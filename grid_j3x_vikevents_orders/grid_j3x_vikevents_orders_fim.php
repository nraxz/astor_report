...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____grid_j3x_vikevents_orders"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____grid_j3x_vikevents_orders"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_j3x_vikevents_orders</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_j3x_vikevents_orders']['embutida_filho'] as $ind => $sc_init)
          {
