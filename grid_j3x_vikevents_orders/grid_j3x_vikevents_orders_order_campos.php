...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["nominative"]   = "nominative";
   ...
   $tab_converte["custdata"]   = "custdata";
   ...
   $tab_converte["membdata"]   = "membdata";
   ...
   $tab_converte["discount"]   = "discount";
   ...
   $tab_converte["strmultiprices"]   = "strmultiprices";
   ...
   if ($use_alias == "S")
   {
       ...
       $tab_converte["ticket_detail"]   = "ticket_detail";
   }
   else
   {
       $tab_def_campos['ticket_detail'] = "";
       $tab_converte[""]   = "ticket_detail";
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_j3x_vikevents_orders']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
