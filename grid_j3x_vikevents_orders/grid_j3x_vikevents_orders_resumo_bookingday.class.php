...
class grid_j3x_vikevents_orders_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_bookingday = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_j3x_vikevents_orders']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_j3x_vikevents_orders']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['contr_total_geral'] == "OK")
      {
          $this->array_total_bookingday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_total']['bookingday'];
      }
      else
      {
          $this->array_total_bookingday = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_total']['bookingday'] = $this->array_total_bookingday;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['id'] = "Order ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['nominative']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['nominative'] = "Nominative"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['custdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['custdata'] = "Custdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['membdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['membdata'] = "Membdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['persons']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['persons'] = "# of Tickets"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['tot']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['tot'] = "Total Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['strmultiprices']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['strmultiprices'] = "Strmultiprices"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['ticket_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['ticket_detail'] = "Tickets"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['uid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['uid'] = "Uid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['iditem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['iditem'] = "Iditem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['ts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['ts'] = "Ts"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['scode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['scode'] = "Scode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['idpayment']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['idpayment'] = "Idpayment"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['totpaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['totpaid'] = "Totpaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['purchemail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['purchemail'] = "Purchemail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['bookingday']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['bookingday'] = "Bookingday"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['couponstr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['couponstr'] = "Couponstr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['checkins']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['checkins'] = "Checkins"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['session']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['session'] = "Session"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['lastupdts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['lastupdts'] = "Lastupdts"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['paymentlog']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['paymentlog'] = "Paymentlog"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['donation']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['donation'] = "Donation"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['adminnotes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['adminnotes'] = "Adminnotes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['lang']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['lang'] = "Lang"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['elder']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['elder'] = "Elder"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['country']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['labels']['country'] = "Country"; 
       }
       //-----
       $this->comp_field_nm = array(
           'bookingday' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Persons (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Tot (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_order']['bookingday']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_order']['bookingday'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_order']['bookingday'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['summarizing_fields_display']['bookingday'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "persons", 'show' => true),
           3 => array('field' => "tot", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_bookingday as $i_bookingday => $d_bookingday) {
           if (!in_array($i_bookingday, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_bookingday[4] ] = $d_bookingday[3];
               $this->comp_label[0][ $d_bookingday[4] ] = $d_bookingday[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'bookingday', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_bookingday => $l_bookingday) {
           if (isset($this->array_total_bookingday[$i_bookingday])) {
               $this->comp_group[$i_bookingday] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_bookingday;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_j3x_vikevents_orders@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Persons (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'bookingday',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_bookingday)),
               'label_y'  => $this->getChartText(strip_tags("Persons (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Tot (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'bookingday',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_bookingday)),
               'label_y'  => $this->getChartText(strip_tags("Tot (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_j3x_vikevents_orders_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_j3x_vikevents_orders_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_j3x_vikevents_orders_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_bookingday("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_bookingday);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " j3x_vikevents_orders</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_j3x_vikevents_orders_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_j3x_vikevents_orders_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_j3x_vikevents_orders_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_j3x_vikevents_orders&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_config_graf_flash.php?nome_apl=grid_j3x_vikevents_orders&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_j3x_vikevents_orders_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_j3x_vikevents_orders']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_j3x_vikevents_orders']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_j3x_vikevents_orders_config_pivot.php?nome_apl=grid_j3x_vikevents_orders&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_j3x_vikevents_orders_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_j3x_vikevents_orders/grid_j3x_vikevents_orders_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $uid = $Busca_temp['uid']; 
          $tmp_pos = strpos($uid, "##@@");
          if ($tmp_pos !== false && !is_array($uid))
          {
              $uid = substr($uid, 0, $tmp_pos);
          }
          $iditem = $Busca_temp['iditem']; 
          $tmp_pos = strpos($iditem, "##@@");
          if ($tmp_pos !== false && !is_array($iditem))
          {
              $iditem = substr($iditem, 0, $tmp_pos);
          }
          $persons = $Busca_temp['persons']; 
          $tmp_pos = strpos($persons, "##@@");
          if ($tmp_pos !== false && !is_array($persons))
          {
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_j3x_vikevents_orders']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " j3x_vikevents_orders</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_persons, $sum_tot, $quebra_bookingday, $quebra_bookingday_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDDHHII'] . "
      if (!isset($this->array_total_bookingday[$quebra_bookingday_orig]))
      {
         $this->array_total_bookingday[$quebra_bookingday_orig][0] = 1;
         $this->array_total_bookingday[$quebra_bookingday_orig][1] = $sum_persons;
         $this->array_total_bookingday[$quebra_bookingday_orig][2] = $sum_tot;
         $this->array_total_bookingday[$quebra_bookingday_orig][3] = $quebra_bookingday;
         $this->array_total_bookingday[$quebra_bookingday_orig][4] = $quebra_bookingday_orig;
      }
      else
      {
         $this->array_total_bookingday[$quebra_bookingday_orig][0]++;
         $this->array_total_bookingday[$quebra_bookingday_orig][1] += $sum_persons;
         $this->array_total_bookingday[$quebra_bookingday_orig][2] += $sum_tot;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'bookingday');
     $campos_order = $this->Ini->Get_date_order_groupby("FROM_UNIXTIME(daytsattend)", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nominative = $rs_res->fields[1] ;  
            $this->custdata = $rs_res->fields[2] ;  
            $this->membdata = $rs_res->fields[3] ;  
            $this->persons = $rs_res->fields[4] ;  
            $this->tot = $rs_res->fields[5] ;  
            $this->tot =  str_replace(",", ".", $this->tot);
            $this->discount = $rs_res->fields[6] ;  
            $this->status = $rs_res->fields[7] ;  
            $this->strmultiprices = $rs_res->fields[8] ;  
            $this->uid = $rs_res->fields[9] ;  
            $this->iditem = $rs_res->fields[10] ;  
            $this->ts = $rs_res->fields[11] ;  
            $this->bookingday = $rs_res->fields[12] ;  
...
$_SESSION['scriptcase']['grid_j3x_vikevents_orders']['contr_erro'] = 'off'; 
            ...
            $this->bookingday_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->bookingday, $Format_tst);
            $this->bookingday = $this->Ini->GB_date_format($TP_Time . $this->bookingday, $Format_tst);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->persons, $this->tot, $this->bookingday, $this->bookingday_orig);
            }
   }
//
