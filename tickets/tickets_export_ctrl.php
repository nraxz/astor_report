<?php
@session_start() ;
$_SESSION['scriptcase']['tickets']['sc_process_barr'] = true;
require_once('../tickets/index.php');
unset($_SESSION['scriptcase']['tickets']['sc_process_barr']);
$ExportCtrl = new tickets_export_control;
$ExportCtrl->Export_barr();

class tickets_export_control
{
