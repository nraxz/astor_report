...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____tickets"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____tickets"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tickets']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['tickets']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tickets']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['tickets']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['tickets']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['tickets']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['tickets']['embutida_filho'] as $ind => $sc_init)
          {
