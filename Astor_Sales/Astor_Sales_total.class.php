...
class Astor_Sales_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['Astor_Sales']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['Astor_Sales']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(j3x_vikevents_orders.iditem) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), count(j3x_vikevents_orders.iditem) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_pesq']; 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['interativ_search'] = array();
              $this->quebra_geral_SalesByVenue();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_total_geral'] = "OK";
   } 
