<?php
@session_start() ;
$_SESSION['scriptcase']['Astor_Sales']['sc_process_barr'] = true;
require_once('../Astor_Sales/index.php');
unset($_SESSION['scriptcase']['Astor_Sales']['sc_process_barr']);
$ExportCtrl = new Astor_Sales_export_control;
$ExportCtrl->Export_barr();

class Astor_Sales_export_control
{
