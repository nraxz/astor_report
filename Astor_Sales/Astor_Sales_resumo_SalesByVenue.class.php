...
class Astor_Sales_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_start_at;
   var $array_total_j3x_vikevents_items_title;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_start_at                  = array();
      $this->array_total_j3x_vikevents_items_title = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['Astor_Sales']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['Astor_Sales']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_total_geral'] == "OK")
      {
          $this->array_total_start_at = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total']['start_at'];
          $this->array_total_j3x_vikevents_items_title = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total']['j3x_vikevents_items_title'];
      }
      else
      {
          $this->array_total_start_at = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total']['start_at'] = $this->array_total_start_at;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total']['j3x_vikevents_items_title'] = $this->array_total_j3x_vikevents_items_title;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_start_at = "Start At";
       $Lab_start_at =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_start_at);
       $Lab_j3x_vikevents_items_title = "Title";
       $this->comp_field = array(
           $Lab_start_at,
           $Lab_j3x_vikevents_items_title,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_price'] = "Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_persons']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_persons'] = "Persons"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_custdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_custdata'] = "Custdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_purchemail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_purchemail'] = "Purchemail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_tot']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_tot'] = "Tot"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_title']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_items_title'] = "Title"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_iditem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_iditem'] = "Iditem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_persons_1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_persons_1'] = "Persons"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['start_at']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['start_at'] = "Start At"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_membdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_membdata'] = "Membdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_totpaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_totpaid'] = "Totpaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['labels']['j3x_vikevents_orders_id'] = "Id"; 
       }
       //-----
       $this->comp_field_nm = array(
           'start_at' => 0,
           'j3x_vikevents_items_title' => 1,
       );

       //-----
       $this->comp_sum = array(
           2 => "Iditem (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_order']['SalesByVenue']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_order']['SalesByVenue'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_order']['SalesByVenue'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['summarizing_fields_display']['SalesByVenue'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "j3x_vikevents_orders_iditem", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_j3x_vikevents_orders_iditem_cnt",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "j3x_vikevents_orders_iditem_cnt",
       );

       //-----
       foreach ($this->array_total_start_at as $i_start_at => $d_start_at) {
           if (!in_array($i_start_at, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_start_at[3] ] = $d_start_at[2];
               $this->comp_label[0][ $d_start_at[3] ] = $d_start_at[2];
           }
           foreach ($this->array_total_j3x_vikevents_items_title[$i_start_at] as $i_j3x_vikevents_items_title => $d_j3x_vikevents_items_title) {
               if (!in_array($i_j3x_vikevents_items_title, $this->comp_label[1][ $d_start_at[3] ], true)) {
                   $this->comp_index[1][ $d_j3x_vikevents_items_title[3] ] = $d_j3x_vikevents_items_title[2];
                   $this->comp_label[1][ $d_start_at[3] ][ $d_j3x_vikevents_items_title[3] ] = $d_j3x_vikevents_items_title[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'start_at', 'prot' => '@aspass@'),
           array('name' => 'j3x_vikevents_items_title', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_start_at => $l_start_at) {
           if (isset($this->array_total_start_at[$i_start_at])) {
               $this->comp_group[$i_start_at] = array();
           }
           foreach ($this->comp_label[1][$i_start_at] as $i_j3x_vikevents_items_title => $l_j3x_vikevents_items_title) {
               if (isset($this->array_total_j3x_vikevents_items_title[$i_start_at][$i_j3x_vikevents_items_title])) {
                   $this->comp_group[$i_start_at][$i_j3x_vikevents_items_title] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_start_at;
       }
       elseif (1 == $level) {
           $return = $this->array_total_j3x_vikevents_items_title;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Astor_Sales@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new Astor_Sales_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_SalesByVenue("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_start_at);
      ksort($this->array_total_j3x_vikevents_items_title);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Astor_Sales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Astor_Sales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Astor_Sales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=Astor_Sales&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Astor_Sales/Astor_Sales_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("Astor_Sales_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Astor_Sales']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Astor_Sales']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'Astor_Sales_config_pivot.php?nome_apl=Astor_Sales&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Astor_Sales_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "Astor_Sales/Astor_Sales_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Astor_Sales']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $start_at = $Busca_temp['start_at']; 
          $tmp_pos = strpos($start_at, "##@@");
          if ($tmp_pos !== false && !is_array($start_at))
          {
              $start_at = substr($start_at, 0, $tmp_pos);
          }
          $start_at_2 = $Busca_temp['start_at_input_2']; 
          $j3x_vikevents_items_title = $Busca_temp['j3x_vikevents_items_title']; 
          $tmp_pos = strpos($j3x_vikevents_items_title, "##@@");
          if ($tmp_pos !== false && !is_array($j3x_vikevents_items_title))
          {
              $j3x_vikevents_items_title = substr($j3x_vikevents_items_title, 0, $tmp_pos);
          }
          $j3x_vikevents_items_price = $Busca_temp['j3x_vikevents_items_price']; 
          $tmp_pos = strpos($j3x_vikevents_items_price, "##@@");
          if ($tmp_pos !== false && !is_array($j3x_vikevents_items_price))
          {
   ...
   //---- 
   function adiciona_registro($cnt_j3x_vikevents_orders_iditem, $quebra_start_at, $quebra_j3x_vikevents_items_title, $quebra_start_at_orig, $quebra_j3x_vikevents_items_title_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_start_at[$quebra_start_at_orig]))
      {
         $this->array_total_start_at[$quebra_start_at_orig][0] = 1;
         $this->array_total_start_at[$quebra_start_at_orig][1] = 1;
         $this->array_total_start_at[$quebra_start_at_orig][2] = $quebra_start_at;
         $this->array_total_start_at[$quebra_start_at_orig][3] = $quebra_start_at_orig;
      }
      else
      {
         $this->array_total_start_at[$quebra_start_at_orig][0]++;
         $this->array_total_start_at[$quebra_start_at_orig][1] ++;
      }
      //----- Title
      if (!isset($this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig]))
      {
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][0] = 1;
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][1] = 1;
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][2] = $quebra_j3x_vikevents_items_title;
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][3] = $quebra_j3x_vikevents_items_title_orig;
      }
      else
      {
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][0]++;
         $this->array_total_j3x_vikevents_items_title[$quebra_start_at_orig][$quebra_j3x_vikevents_items_title_orig][1] ++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'start_at');
     $campos_order = $this->Ini->Get_date_order_groupby("FROM_UNIXTIME(j3x_vikevents_items.tsinit)", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'j3x_vikevents_items_title');
     $campos_order = $this->Ini->Get_date_order_groupby("j3x_vikevents_items.title", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->j3x_vikevents_items_price = $rs_res->fields[0] ;  
            $this->j3x_vikevents_items_price =  str_replace(",", ".", $this->j3x_vikevents_items_price);
            $this->j3x_vikevents_orders_persons = $rs_res->fields[1] ;  
            $this->j3x_vikevents_orders_custdata = $rs_res->fields[2] ;  
            $this->j3x_vikevents_orders_purchemail = $rs_res->fields[3] ;  
            $this->j3x_vikevents_orders_tot = $rs_res->fields[4] ;  
            $this->j3x_vikevents_orders_tot =  str_replace(",", ".", $this->j3x_vikevents_orders_tot);
            $this->j3x_vikevents_items_id = $rs_res->fields[5] ;  
            $this->j3x_vikevents_items_title = $rs_res->fields[6] ;  
            $this->j3x_vikevents_orders_iditem = $rs_res->fields[7] ;  
            $this->j3x_vikevents_orders_persons_1 = $rs_res->fields[8] ;  
            $this->start_at = $rs_res->fields[9] ;  
            $this->j3x_vikevents_orders_totpaid = $rs_res->fields[10] ;  
            $this->j3x_vikevents_orders_totpaid =  str_replace(",", ".", $this->j3x_vikevents_orders_totpaid);
            $this->j3x_vikevents_orders_id = $rs_res->fields[11] ;  
            $Format_tst = $this->Ini->Get_Gb_date_format('SalesByVenue', 'start_at');
            $TP_Time    = (in_array('start_at', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
            $this->start_at_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->start_at, $Format_tst);
            $this->start_at = $this->Ini->GB_date_format($TP_Time . $this->start_at, $Format_tst, "N", "F/Y");
            $this->j3x_vikevents_items_title_orig = $this->j3x_vikevents_items_title;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->j3x_vikevents_orders_iditem, $this->start_at, $this->j3x_vikevents_items_title, $this->start_at_orig,  $this->j3x_vikevents_items_title_orig);
            }
   }
//
