...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____Astor_Sales"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____Astor_Sales"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Astor_Sales']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Astor_Sales']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Astor_Sales']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Astor_Sales']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Astor_Sales']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Astor_Sales']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Astor_Sales']['embutida_filho'] as $ind => $sc_init)
          {
