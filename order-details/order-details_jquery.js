...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_order-details').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_order-details').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_order-details').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_order-details').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_order-details').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_order-details').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_order-details').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_order-details').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_order-details').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_order-details').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_order-details').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_order-details').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
