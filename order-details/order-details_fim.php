...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["AstorReport_____order-details"]))
   {
      unset($_SESSION['session_sec_aplicacao']["AstorReport_____order-details"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['order-details']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['order-details']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['order-details']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['order-details']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['order-details']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['order-details']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['order-details']['embutida_filho'] as $ind => $sc_init)
          {
