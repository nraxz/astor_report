<?php
@session_start() ;
$_SESSION['scriptcase']['order-details']['sc_process_barr'] = true;
require_once('../order-details/index.php');
unset($_SESSION['scriptcase']['order-details']['sc_process_barr']);
$ExportCtrl = new order_details_export_control;
$ExportCtrl->Export_barr();

class order_details_export_control
{
