...
class order_details_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['order-details']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['order-details']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['contr_total_geral'] == "OK")
      {
          $this->array_total_bookingday = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_total']['bookingday'];
      }
      else
      {
          $this->array_total_bookingday = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_total']['bookingday'] = $this->array_total_bookingday;
      $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['id'] = "Order ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['nominative']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['nominative'] = "Nominative"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['custdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['custdata'] = "Custdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['membdata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['membdata'] = "Membdata"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['persons']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['persons'] = "# of Tickets"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['tot']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['tot'] = "Total Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['strmultiprices']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['strmultiprices'] = "Strmultiprices"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['ticket_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['ticket_detail'] = "Tickets"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['uid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['uid'] = "Uid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['iditem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['iditem'] = "Iditem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['ts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['ts'] = "Ts"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['scode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['scode'] = "Scode"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['idpayment']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['idpayment'] = "Idpayment"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['totpaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['totpaid'] = "Totpaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['purchemail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['purchemail'] = "Purchemail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['bookingday']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['bookingday'] = "Bookingday"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['couponstr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['couponstr'] = "Couponstr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['checkins']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['checkins'] = "Checkins"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['session']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['session'] = "Session"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['lastupdts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['lastupdts'] = "Lastupdts"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['paymentlog']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['paymentlog'] = "Paymentlog"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['donation']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['donation'] = "Donation"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['adminnotes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['adminnotes'] = "Adminnotes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['lang']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['lang'] = "Lang"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['elder']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['elder'] = "Elder"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['country']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['labels']['country'] = "Country"; 
       }
       //-----
       $this->comp_field_nm = array(
           'bookingday' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_order']['bookingday']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_order']['bookingday'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_order']['bookingday'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['summarizing_fields_display']['bookingday'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@order-details@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_order-details_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_order-details_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new order_details_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_order-details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_order-details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_order-details_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "order-details/order-details_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=order-details&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=order-details&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "order-details/order-details_config_graf_flash.php?nome_apl=order-details&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("order-details_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['order-details']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['order-details']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'order-details_config_pivot.php?nome_apl=order-details&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_order-details_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "order-details/order-details_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['order-details']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
