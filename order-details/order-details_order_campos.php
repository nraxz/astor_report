...
<?php
   ...
   $Ord_Cmp = new order_details_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class order_details_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['order-details']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["id"] : "Order ID";
   $tab_ger_campos['nominative'] = "on";
   $tab_def_campos['nominative'] = "nominative";
   $tab_labels["nominative"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["nominative"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["nominative"] : "Nominative";
   $tab_ger_campos['custdata'] = "on";
   $tab_def_campos['custdata'] = "custdata";
   $tab_labels["custdata"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["custdata"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["custdata"] : "Custdata";
   $tab_ger_campos['membdata'] = "on";
   $tab_def_campos['membdata'] = "membdata";
   $tab_labels["membdata"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["membdata"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["membdata"] : "Membdata";
   $tab_ger_campos['persons'] = "on";
   $tab_def_campos['persons'] = "persons";
   $tab_labels["persons"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["persons"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["persons"] : "# of Tickets";
   $tab_ger_campos['tot'] = "on";
   $tab_def_campos['tot'] = "tot";
   $tab_labels["tot"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["tot"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["tot"] : "Total Sales";
   $tab_ger_campos['discount'] = "on";
   $tab_def_campos['discount'] = "discount";
   $tab_labels["discount"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["discount"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["discount"] : "Discount";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["status"] : "Status";
   $tab_ger_campos['strmultiprices'] = "on";
   $tab_def_campos['strmultiprices'] = "strmultiprices";
   $tab_labels["strmultiprices"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["strmultiprices"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["strmultiprices"] : "Strmultiprices";
   ...
   $tab_labels["ticket_detail"]   = (isset($_SESSION['sc_session'][$sc_init]['order-details']['labels']["ticket_detail"])) ? $_SESSION['sc_session'][$sc_init]['order-details']['labels']["ticket_detail"] : "Tickets";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['order-details']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['order-details']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['order-details']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['order-details']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['order-details']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['order-details']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "order-details_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['order-details']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['order-details']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
